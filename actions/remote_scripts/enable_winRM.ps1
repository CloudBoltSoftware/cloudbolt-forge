...
enableWinRM
.\pstools\psexec.exe \\$global:compName -s C:\Windows\system32\winrm.cmd set winrm/config/service ‘@{AllowUnencrypted=”true”}’
.\pstools\psexec.exe \\$global:compName -s C:\Windows\system32\winrm.cmd set winrm/config/service/auth ‘@{Basic=”true”}’
exit 0
