...
def run(job, logger=None):
    ...
    for server in job.server_set.all():
        ...
        script = "dnscmd /recordadd {} {} a {}".format(DNS_ZONE, new_host, new_ip)

        job.set_progress("Registering DNS record for {} at {}.".format(new_host, new_ip))
