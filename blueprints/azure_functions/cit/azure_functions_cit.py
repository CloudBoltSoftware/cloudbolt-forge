        ...
        "deploy-items": [
            {
                ...
                "blueprint-items-arguments": {
                    "build-item-Azure Functions Build": {
                        "parameters": {
                            "file-location-a376": "/home/azfunctions/tested3.zip",
                            "function-name-a376": "cittest001"
                        }
                    }
                },
                "resource-name": "Azure Functions",
                "resource-parameters": {}
            }
        ]
    },
