...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/BP-l2a0o6yy/",
                "blueprint-items-arguments": {
                    "build-item-Azure SQL Server Build": {
                        "parameters": {
                            "env-id-a276": "89",
                            "resource-group-a276": "cit-test-l-0010",
                            "server-name-a276": "testsqlservercit2k20",
                            "server-password-a276": "ttg12!ASFsddf",
                            "server-username-a276": "tester"
                        }
                    }
                },
                "resource-name": "Azure SQL Server",
                "resource-parameters": {}
            }
        ]
    },
...
NEW_RESOURCE_NAME = "testsqlservercit2k20"
