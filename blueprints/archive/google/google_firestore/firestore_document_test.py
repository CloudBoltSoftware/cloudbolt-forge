...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/62/",
                "blueprint-items-arguments": {
                    "build-item-create firestore document": {
                        "parameters": {
                            "collection-a301": "team",
                            "document-name-a301": "gglefstrcit19",
                            "env-id-a301": "57"
                        }
                    }
                },
                "resource-name": "Google Firestore Document",
                "resource-parameters": {}
            }
        ]
    },
...
NEW_RESOURCE_NAME = "gglefstrcit19"
