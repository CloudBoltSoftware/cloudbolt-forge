...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/BP-cy5bwu0x/",
                "blueprint-items-arguments": {
                    "build-item-Create Google Cloud Storage bucket": {
                        "parameters": {
                            "bucket-name-a134": "cit-test-bp-23",
                            "env-id-a134": "57",
                            "storage-type-a134": "MULTI_REGIONAL"
                        }
                    }
                },
                "resource-name": "Google Storage CIT",
                "resource-parameters": {}
            }
        ]
    },
