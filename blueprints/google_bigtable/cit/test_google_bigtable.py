...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/BP-9fy6a8zu/",
                "blueprint-items-arguments": {
                    "build-item-Google Bigtable Database Create Service": {
                        "parameters": {
                            "db-identifier-a153": "cit-test-bigtable-314159",
                            "env-id-a153": "2",
                            "zone-a153": "79"
                        }
                    }
                },
                "resource-name": "Google Bigtable",
                "resource-parameters": {}
            }
        ]
    },
...
NEW_RESOURCE_NAME = "cit-test-bigtable-314159"
