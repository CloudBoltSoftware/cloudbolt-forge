...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/74/",
                "blueprint-items-arguments": {
                    "build-item-AWS Load Balancer Build": {
                        "parameters": {
                            "balancer-type-a339": "application",
                            "env-id-a339": "23",
                            "iptype-a339": "ipv4",
                            "name-a339": "awslbtestingname2k19",
                            "scheme-a339": "internet-facing",
                            "subnet1-a339": "subnet-22ec1509",
                            "subnet2-a339": "subnet-82a280d8"
                        }
                    }
                },
                "resource-name": "AWS Load Balancer",
                "resource-parameters": {}
            }
        ]
    },
...
NEW_RESOURCE_NAME = "awslbtestingname2k19"
...
def run(job, *args, **kwargs):
    ...
    if delete_result != "SUCCESS":
        return "FAILURE", "Unable to delete this Load balancer", ""
