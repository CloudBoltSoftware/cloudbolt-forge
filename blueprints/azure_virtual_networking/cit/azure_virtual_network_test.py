...
BP_PAYLOAD = """
{
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/BP-i1gvmj1n/",
                "blueprint-items-arguments": {
                    "build-item-Azure Virtual Network Build": {
                        "parameters": {
                            "env-id-a408": "18",
                            "resource-group-a408": "AaronRM-33063",
                            "subnet-adress-prefix-a408": "10.0.0.0/24",
                            "virtual-net-name-a408": "azvnetworkcit1",
                            "vpn-adress-prefix-a408": "10.0.0.0/16"
                        }
                    }
                },
                "resource-name": "Azure Virtual Network",
                "resource-parameters": {}
            }
        ]
    },
...
NEW_RESOURCE_NAME = "azvnetworkcit1 - AaronRM-33063"
