...
BP_PAYLOAD = """
    ...
    "items": {
        "deploy-items": [
            {
                "blueprint": "/api/v2/blueprints/99/",
                "blueprint-items-arguments": {
                    "build-item-Install MySql On Centos": {},
                    "build-item-Install MySql On Ubuntu": {},
                    "build-item-Mysql database": {
                        "attributes": {
                            "hostname": "forcittest",
                            "quantity": 1
                        },
                        "environment": "/api/v2/environments/108/",
                        "os-build": "/api/v2/os-builds/26",
                        "parameters": {
                            "cpu-cnt": "2",
                            "mem-size": "20 GB",
