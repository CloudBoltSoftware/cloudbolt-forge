instance_types = [('a1.medium', 'a1.medium'),
                  ('a1.large', 'a1.large'),
                  ('a1.xlarge', 'a1.xlarge'),
...
disk_types = [
    ('GeneralPurposeSSD', 'GeneralPurposeSSD'),
    ('ProvisionedIOPSSSD', 'ProvisionedIOPSSSD'),
    ('ColdHDD', 'ColdHDD'),
    ('ThroughtputOptimizedHDD', 'ThroughtputOptimizedHDD'),
    ('Magnetic', 'Magnetic')
]

license_types = [
    ('BYOL', 'BYOL'),
    ('ProvidedByAWS', 'ProvidedByAWS'),
]
